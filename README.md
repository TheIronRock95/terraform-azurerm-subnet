...
| service\_delegation\_actions | A list of Actions which should be delegated. | `list(string)` | yes |
| service\_delegation\_name | The name of service to delegate to. | `string` | yes |
